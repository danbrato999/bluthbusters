...
const routes: Routes = [
    ...
    { path: 'movies/add', component: MovieFormComponent, canActivate: [AngularFireAuthGuard], data: { authGuardPipe: redirectUnauthorizedToLogin } },
    ...
    { path: 'movies/:movieId/edit', component: MovieFormComponent, canActivate: [AngularFireAuthGuard], data: { authGuardPipe: redirectUnauthorizedToLogin }  },
